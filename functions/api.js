export async function onRequestPost(context) {
  try {
    ...
    const body = {
      model: 'moonshot-v1-8k',          // ← 换掉旧模型
      stream: false,
      temperature: 0,
      messages: [
        {
          role: 'system',
          content: '现在你是塔罗牌大师，根据我所选的牌去根据问题去解析，使用的是22张大阿尔克那牌，' +
            JSON.stringify({
            ...
            '，下面我将以数组的形式给你卡牌，其中isReversed代表是否为逆位，no为从 0 到 21 对应的22张大阿尔克那牌，你在解析的时候，需要把0-21用22张大阿尔克那牌对应的名称回答，你只需要解释卡牌的含义及解析，最后结尾用百分比表示问题的概率，不用回答多余的话'
        },
        {
          role: 'user',
